...
export default function Footer() {
  ...
  return (
    <footer className="w-full py-8 px-4 md:px-8 bg-gray-900 text-gray-300">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div>
            <h2 className="text-xl font-bold">
              <span className="text-blue-400">Arbi</span>Suite
            </h2>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="text-sm text-gray-500">
            <a href="mailto:arbisuite@gmail.com" className="text-gray-400 hover:text-blue-400 transition-colors">
              arbisuite@gmail.com
            </a>
          </div>
        </div>
